...
public class Program
{
  ...
  public static async Task Main(string[] args)
  {
    ...
    await SendSearchRequest("ist");

    Console.WriteLine("`ist` search done!...");

    await SendSearchRequest("Izm");

    Console.WriteLine("`Izm` search done!...");

    await SendSearchRequest("İzm");

    Console.WriteLine("`İzm` search done!...");

    await SendSearchRequest("donus");

    Console.WriteLine("`donus` search done!...");
  }
...
{
  [SearchableField(IsKey = true, IsFilterable = true, IsSortable = true, AnalyzerName = LexicalAnalyzerName.Values.SrLatinMicrosoft)]
  public string Id { get; set; } = string.Empty;
  [SearchableField(IsFilterable = true, AnalyzerName = LexicalAnalyzerName.Values.SrLatinMicrosoft)]
  public string CarrierId { get; set; } = string.Empty;
  [SearchableField(IsFilterable = true, AnalyzerName = LexicalAnalyzerName.Values.SrLatinMicrosoft)]
  public string CarrierCompanyTitle { get; set; } = string.Empty;
  [SearchableField(IsFilterable = true, AnalyzerName = LexicalAnalyzerName.Values.SrLatinMicrosoft)]
  public string Name { get; set; } = string.Empty;
  [SearchableField(AnalyzerName = LexicalAnalyzerName.Values.SrLatinMicrosoft)]
  public string Description { get; set; } = string.Empty;
  [SearchableField(IsFilterable = true, IsFacetable = true, AnalyzerName = LexicalAnalyzerName.Values.SrLatinMicrosoft)]
